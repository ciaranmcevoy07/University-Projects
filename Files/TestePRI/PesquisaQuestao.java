...
public class PesquisaQuestao {
    ...
    private static Map<String, Pair<Integer, Integer>> ReceiveDict (HashMap<String,Pair<Integer,ArrayList<Pair<Integer,ArrayList<Integer>>>>> dicionario) {
        Map<String, Pair<ArrayList<Integer>, Pair<Integer, Integer>>> t_docid_tf_df = new HashMap<>();
